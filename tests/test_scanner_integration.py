...
class ScannerIntegrationTests(unittest.TestCase):
    ...
    def test_both_profiles_are_evaluated_but_only_one_primary_signal_is_kept_per_symbol(self) -> None:
        ...
        self.assertEqual(primary["confirmation_count"], 0)
        self.assertAlmostEqual(primary["risk_reward"], 1.5)
        self.assertFalse(primary["profile_adjusted_target"])
        ...
        self.assertAlmostEqual(intraday_result["risk_reward"], 1.5)
