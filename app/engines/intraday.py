...
from app.engines.profiles import INTRADAY_PROFILE, apply_strategy_profile
...
def build_context(
    *,
    ...
    return {
        "symbol": symbol,
        "trade_type": INTRADAY_PROFILE.trade_type,
        "engine_profile": INTRADAY_PROFILE.trade_type,
        "trend": dict(trend),
...
def evaluate_strategies(
    *,
    ...
    return [apply_strategy_profile(result, INTRADAY_PROFILE) for result in raw_results]
